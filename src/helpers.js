...
async function getInstruments() {
  ...
  for(var i in instruments){
    ...
    if(instSymMap==undefined)
      instSymMap={};
    instSymMap[inst.instrument_token]=inst.tradingsymbol;
  }
  return instruments;
}
...
async function getOHLCData(){
  if(!prevOHLC){
    try{
    console.log("loading OHLC");  
    prevOHLC=await readFile('ohlcPrev');
    console.log("loaded OHLC");
  }
  catch(e){
    console.log(e);
  }
...
function regularOrderPlace(variety,params) {
